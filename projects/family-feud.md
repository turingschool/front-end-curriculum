...
To populate your data for Family Feud, you will be using [this data](https://repl.it/@brittanystoroz/FamilyFeud). Copy this into a separate `js` file that you can include as a `script` tag in your HTML file.
