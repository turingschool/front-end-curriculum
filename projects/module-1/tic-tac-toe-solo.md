...
2. A `game.js` file that contains a Game class. 
  * A `Game` should include:
      ...
      - A way to check the game board for win conditions
      - A way to detect when a game is a draw (no one has won)
      -  A way to save a winning game board to the correct player's `wins` array
      -  A way to reset the game board to begin a new game
