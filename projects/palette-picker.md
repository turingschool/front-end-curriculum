...
## Create one submission file for your project based on [this template](https://github.com/turingschool/front-end-submissions-public/blob/master/1801/mod-4/palette-picker/submission-template.md) by copying it to a new file called YOURNAME.md in the same directory. Submit it as a PR to the front-end-submissions repo by 1pm on Friday of week 1.
