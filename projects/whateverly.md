...
- The application shows effort in the interface, but the result is not effective as there are holes in the UX, UI, or both. It is not clear that the user stories helped to guide UX.
