...
In order to demystify some of the complex structure we'll see in the future, let's explore the [Fitlit Starter Kit](https://github.com/turingschool-examples/fitlit-starter-kit) repo.
