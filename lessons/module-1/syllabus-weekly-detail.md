...
|Assignment  | __DUE__: Wed 1/31 end of day Dog Party Static Comp |
|Assignment  | __EVAL__: Thu 2/1 ~ Number Guesser |
...
|Assignment  | __EVAL__: Wed 2/7 ~ Mid Mock Assessment |
|Assignment  | __EVAL__: Thu 2/8 ~ Linked List |
...
|Assignment  | __DUE__:   Tues 2/13 ~ Static Comp Challenge #1 by *12:00 PM* |
|Assignment  | __EVAL__:  Thu 2/15 ~ Ideabox |
|Assignment  | __DUE__: Fri 2/16 ~ Mythical Creatures |
...
|Pentathlon  | __EVAL__: Mon 2/26 ~ DOM Challenge I |
|Pentathlon  | __EVAL__: Tue 2/27 ~ Vanilla JS Logic Challenge II |
|Pentathlon  | __EVAL__: Wed 2/28 ~ Static Comp Challenge #3 & Quizlette|
|Pentathlon  | __EVAL__: Thu 3/1 ~ Portfolio Defense |
