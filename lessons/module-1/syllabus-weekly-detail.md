...
|Assignment  | __CHECK-IN__: Thu 11/29 ~ Dog Party |
...
|Assignment  | __Eval__: Mon 12/3 ~ Dog Party
|Assignment  | __CHECK-IN__: Thu 12/6 ~ Number Guesser |
...
|Assignment  | __CHECK-IN__: Tue 12/11 ~ Number Guesser |
|Assignment  | __DUE__: Tue 12/12 ~ Static Comp Challenge #1 by *8:00 AM* |
|Assignment  | __EVAL__: Wed 12/12 ~ Mid Mock Assessment |
|Assignment  | __EVAL__: Thu 12/13 ~ Number Guesser |
...
|Assignment  | __CHECK-IN__:  Thu 12/20 ~ Ideabox |
|Assignment  | __DUE__: Fri 12/21 ~ Mythical Creatures |
...
|Assignment  | __DUE__:  Wed 1/2 ~ Static Comp Challenge #2 by *8:00 AM* |
|Assignment  | __DUE__:  Thu 1/3 ~ Lightning Talk |
|Assignment  | __EVAL__: Thu 1/3 ~ IdeaBox |
...
|Assignment  | __CHECK-IN__: Mon 1/7 ~ Foto Finder |
|Final Exam  | __EVAL__: Tue 1/8 ~ Final Exam |
|Assignment  | __EVAL__: Wed 1/9 ~ Foto Finder|
|Assignment  | __EVAL__: Thu 1/10 ~ Portfolio Defense |
