...
- `Callback function` a function which is passed to another function as an argument which is invoked at a later time
- `EventListener` A callback function that will run when a specific event occurs
