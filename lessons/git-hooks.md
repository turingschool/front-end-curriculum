...
Git allows us to effectively 'pause' the commit cycle at each of these four phases through the use of hooks.

Let's implement a `pre-commit` hook that prevents any commits where tests or linting rules do not pass.
